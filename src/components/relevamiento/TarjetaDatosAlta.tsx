 ...
 *
 * Qué abre cada renglón (ficha primero si falta, etc.) lo decide VisitaFlow.
 */
export default function TarjetaDatosAlta({ fichaPendiente, progreso, onAbrirFicha, onAbrirRelevamiento }: TarjetaDatosAltaProps) {
    return (
        <section
