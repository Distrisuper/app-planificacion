...
const motivos = [
    { motivoId: 1, nivel: 'visita' as const, descripcion: 'Saqué pedido', resultado: 'ganado' as const, codigo: null, campos: [] },
    { motivoId: 4, nivel: 'visita' as const, descripcion: 'Precio', resultado: 'perdido' as const, codigo: null, campos: [] },
]
